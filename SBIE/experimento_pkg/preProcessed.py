...
def exportToAloneFileEmotionsProbabilitiesCSV():
    ...
    log = open("/home/anderson/projetos/SSFER/SBIE/experimento_pkg/preProcessedClassification_SSFER/CSV-emotionsProbabilities/merge-emotionsProbabilities.csv", "a+")
...
def exportToAloneFileEmotionsCSV():
    ...
    log = open("/home/anderson/projetos/SSFER/SBIE/experimento_pkg/preProcessedClassification_SSFER/CSV-emotionsProbabilities/merge-emotions.csv", "a+")
...
def exportToFileEmotionsCSV (user):
    with open ("/home/anderson/projetos/SSFER/SBIE/experimento_pkg/logs_SSFER/"+user+".csv") as fp:
        log = open("/home/anderson/projetos/SSFER/SBIE/experimento_pkg/preProcessedClassification_SSFER/CSV-emotionsProbabilities/merge-emotions.csv", "a+")
        for line in fp:
            obj = line.replace("\n", "")
            objV = obj.split("$")
...
def exportToEmotionsProbabilitiesCSV (user):
    with open ("/home/anderson/projetos/SSFER/SBIE/experimento_pkg/logs_SSFER/"+user+".csv") as fp:
        log = open("/home/anderson/projetos/SSFER/SBIE/experimento_pkg/preProcessedClassification_SSFER/CSV-emotionsProbabilities/"+user+"-emotionsProbabilities.csv", "a+")
...
exportToEmotionsProbabilitiesCSV("aluno1")

def exportToArff (user):
    with open ("/home/anderson/projetos/SSFER/SBIE/experimento_pkg/logs_SSFER/"+user+".csv") as fp:
        log = open("/home/anderson/projetos/SSFER/SBIE/experimento_pkg/preProcessedClassification_SSFER/ARFF/"+user+".arff", "a+")
...
def exportAllToArff():
    log = open("/home/anderson/projetos/SSFER/SBIE/experimento_pkg/preProcessedClassification_SSFER/ARFF/merge-data.arff", "a+")
    header = """% 1. Title: Emotion Recognition EETI
% 
% 2. Sources:
%      (a) Creator: Anderson Araujo da Cruz 
