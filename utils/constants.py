...
def getDataPath():
    ...
    NOVAEMOTIONS_DATA = os.path.join(pwd, 'novaemotions-data.npy')
    RAFD_DATA = os.path.join(pwd, 'RafD-data.npy')
    return [CIFE_DATA, CK_DATA, FER_DATA, JAFFE_DATA, KDEF_DATA, NOVAEMOTIONS_DATA, RAFD_DATA]
...
def getLabelsPath():
    ...
    NOVAEMOTIONS_LABELS = os.path.join(pwd, 'novaemotions-label.npy')
    RAFD_LABELS = os.path.join(pwd, 'RafD-label.npy')
    return [CIFE_LABELS, CK_LABELS, FER_LABELS, JAFFE_LABELS, KDEF_LABELS, NOVAEMOTIONS_LABELS, RAFD_LABELS]
